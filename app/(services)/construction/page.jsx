...
const page = () => {
  return (
    <div className="h-full flex flex-col justify-evenly">
      <h2 className="text-[2rem] underline decoration-2 underline-offset-8 decoration-[#cd9a41] text-center textShadow uppercase">construction services</h2>
      <h3 className="">
      ...
      <ServiceLink href={"/design&build"} directionLeft serviceName={"DESIGN & BUILD"} customCss={"mr-auto"} />
    </div>
  );
};
